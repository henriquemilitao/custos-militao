...
export default function ClientPage({ userId }: { userId: string }) {
  const { cicloAtual, isLoading, mutateCiclo, dataInicio, dataFim } = useCicloAtual(userId);
  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      <HeaderSistema cicloAtual={cicloAtual} mutateCiclo={mutateCiclo} dataInicio={dataInicio} dataFim={dataFim} />
